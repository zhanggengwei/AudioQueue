...
static void VDSAudioFileStreamPropertyListener(void *inClientData,
                                               AudioFileStreamID inAudioFileStream,
                                               AudioFileStreamPropertyID inPropertyID,
                                               UInt32 *ioFlags)
{
    VDAudioFileStream *audioFileStream = (__bridge VDAudioFileStream *)inClientData;
    [audioFileStream handleAudioFileStreamProperty:inPropertyID];
}

static void VDAudioFileStreamPacketsCallBack(void *inClientData,
...
#pragma mark -
@implementation VDAudioFileStream
...
- (BOOL)_openAudioFileStreamWithFileTypeHint:(AudioFileTypeID)fileTypeHint error:(NSError *__autoreleasing *)error
{
    OSStatus status = AudioFileStreamOpen((__bridge void *)self,
                                          VDSAudioFileStreamPropertyListener,
                                          VDAudioFileStreamPacketsCallBack,
                                          fileTypeHint,
                                          &_audioFileStreamID);
                  ...
                  packetDescriptions:(AudioStreamPacketDescription *)packetDescriptioins
{
    ...
    for (int i = 0; i < numberOfPackets; ++i)
    {
        ...
        VDParsedAudioData *parsedData = [VDParsedAudioData parsedAudioDataWithBytes:packets + packetOffset
