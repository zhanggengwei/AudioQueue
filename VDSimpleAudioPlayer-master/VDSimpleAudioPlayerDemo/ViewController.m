...
- (void)viewDidLoad
{
    ...
    if (!_player)
    {
        ...
        _player = [[VDSimpleAudioPlayer alloc] initWithFilePath:path fileType:kAudioFileAC3Type];
        
//        NSString *path = [[NSBundle mainBundle] pathForResource:@"M4ASample" ofType:@"m4a"];
//        _player = [[VDSimpleAudioPlayer alloc] initWithFilePath:path fileType:kAudioFileAAC_ADTSType];
        
//        NSString *path = [[NSBundle mainBundle] pathForResource:@"CAFSample" ofType:@"caf"];
//        _player = [[VDSimpleAudioPlayer alloc] initWithFilePath:path fileType:kAudioFileCAFType];
